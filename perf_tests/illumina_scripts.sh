...
(/usr/bin/time -l Rscript ./illumina.R 1 4) &> \
    illumina_out/runs/jackalope_0.1Mreads_4threads_rep4.out
echo $i

i=$(($i + 1))
(/usr/bin/time -l Rscript ./illumina.R 1 4) &> \
    illumina_out/runs/jackalope_0.1Mreads_4threads_rep2.out
echo $i
...
(/usr/bin/time -l Rscript ./illumina.R 1 1) &> \
    illumina_out/runs/jackalope_0.1Mreads_1threads_rep9.out
echo $i
...
(/usr/bin/time -l ./illumina.sh 1 1) &> \
    illumina_out/runs/art_0.1Mreads_1threads_rep8.out
echo $i

i=$(($i + 1))
(/usr/bin/time -l ./illumina.sh 1 1) &> \
    illumina_out/runs/art_0.1Mreads_1threads_rep4.out
echo $i

i=$(($i + 1))
(/usr/bin/time -l Rscript ./illumina.R 1 1) &> \
    illumina_out/runs/jackalope_0.1Mreads_1threads_rep3.out
echo $i
...
i=$(($i + 1))
(/usr/bin/time -l Rscript ./illumina.R 1 4) &> \
    illumina_out/runs/jackalope_0.1Mreads_4threads_rep10.out
echo $i

i=$(($i + 1))
(/usr/bin/time -l Rscript ./illumina.R 1 4) &> \
    illumina_out/runs/jackalope_0.1Mreads_4threads_rep1.out
echo $i

i=$(($i + 1))
(/usr/bin/time -l Rscript ./illumina.R 1 1) &> \
    illumina_out/runs/jackalope_0.1Mreads_1threads_rep6.out
echo $i
...
i=$(($i + 1))
(/usr/bin/time -l Rscript ./illumina.R 1 4) &> \
    illumina_out/runs/jackalope_0.1Mreads_4threads_rep6.out
echo $i

i=$(($i + 1))
(/usr/bin/time -l Rscript ./illumina.R 1 4) &> \
    illumina_out/runs/jackalope_0.1Mreads_4threads_rep9.out
echo $i
...
i=$(($i + 1))
(/usr/bin/time -l Rscript ./illumina.R 1 1) &> \
    illumina_out/runs/jackalope_0.1Mreads_1threads_rep7.out
echo $i

i=$(($i + 1))
(/usr/bin/time -l ./illumina.sh 1 1) &> \
    illumina_out/runs/art_0.1Mreads_1threads_rep3.out
echo $i
...
i=$(($i + 1))
(/usr/bin/time -l Rscript ./illumina.R 1 1) &> \
    illumina_out/runs/jackalope_0.1Mreads_1threads_rep10.out
echo $i
...
i=$(($i + 1))
(/usr/bin/time -l ./illumina.sh 1 1) &> \
    illumina_out/runs/art_0.1Mreads_1threads_rep7.out
echo $i
...
i=$(($i + 1))
(/usr/bin/time -l Rscript ./illumina.R 1 1) &> \
    illumina_out/runs/jackalope_0.1Mreads_1threads_rep1.out
echo $i
...
i=$(($i + 1))
(/usr/bin/time -l Rscript ./illumina.R 1 1) &> \
    illumina_out/runs/jackalope_0.1Mreads_1threads_rep5.out
echo $i
...
i=$(($i + 1))
(/usr/bin/time -l ./illumina.sh 1 1) &> \
    illumina_out/runs/art_0.1Mreads_1threads_rep5.out
echo $i
...
i=$(($i + 1))
(/usr/bin/time -l Rscript ./illumina.R 1 4) &> \
    illumina_out/runs/jackalope_0.1Mreads_4threads_rep8.out
echo $i
...
i=$(($i + 1))
(/usr/bin/time -l Rscript ./illumina.R 1 1) &> \
    illumina_out/runs/jackalope_0.1Mreads_1threads_rep2.out
echo $i
...
i=$(($i + 1))
(/usr/bin/time -l Rscript ./illumina.R 1 1) &> \
    illumina_out/runs/jackalope_0.1Mreads_1threads_rep4.out
echo $i
...
i=$(($i + 1))
(/usr/bin/time -l ./illumina.sh 1 1) &> \
    illumina_out/runs/art_0.1Mreads_1threads_rep10.out
echo $i

i=$(($i + 1))
(/usr/bin/time -l Rscript ./illumina.R 1 4) &> \
    illumina_out/runs/jackalope_0.1Mreads_4threads_rep7.out
echo $i
...
i=$(($i + 1))
(/usr/bin/time -l Rscript ./illumina.R 1 4) &> \
    illumina_out/runs/jackalope_0.1Mreads_4threads_rep3.out
echo $i
...
i=$(($i + 1))
(/usr/bin/time -l ./illumina.sh 1 1) &> \
    illumina_out/runs/art_0.1Mreads_1threads_rep1.out
echo $i
...
i=$(($i + 1))
(/usr/bin/time -l ./illumina.sh 1 1) &> \
    illumina_out/runs/art_0.1Mreads_1threads_rep6.out
echo $i

i=$(($i + 1))
(/usr/bin/time -l Rscript ./illumina.R 1 4) &> \
    illumina_out/runs/jackalope_0.1Mreads_4threads_rep5.out
echo $i
...
i=$(($i + 1))
(/usr/bin/time -l ./illumina.sh 1 1) &> \
    illumina_out/runs/art_0.1Mreads_1threads_rep9.out
echo $i

i=$(($i + 1))
(/usr/bin/time -l Rscript ./illumina.R 1 1) &> \
    illumina_out/runs/jackalope_0.1Mreads_1threads_rep8.out
echo $i
...
i=$(($i + 1))
(/usr/bin/time -l ./illumina.sh 1 1) &> \
    illumina_out/runs/art_0.1Mreads_1threads_rep2.out
echo $i
