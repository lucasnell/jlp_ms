...
All rate matrices were scaled such that branch lengths were in units of substitutions per site.
...
2 Gb in length.
Memory usage increased by only `r sprintf("%.1f", avg_diff_threads$indelible * 1e3)`kB when
