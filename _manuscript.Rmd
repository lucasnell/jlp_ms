...
pip_plot_cap <- paste("(A) Speed and (B) memory usage comparison between",
                      ...
                      "phylogeny used for the simulations and",
                      "In both plots, rows indicate the size of the genome from which",
                      "variants were generated, and color indicates the program used;",
