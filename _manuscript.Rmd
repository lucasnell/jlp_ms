...
#### xx - Higher-level method information
...
The first two variant creation methods directly specify numbers and locations of mutations and
...
`ms` [@Hudson_2002] or 
`msms` [@Ewing_2010] program.


The last three variant-creation methods simulate sequences using phylogenomic information.
...
A single phylogenetic tree can be used for all genome sequences, or
each sequence can use a separate, independent tree.
