...
(i\) sets of variants from a reference genome and
...
each set based on one reference.
...
There are five ways to generate haploid variants from the reference genome,
phylogeny-free (PF) and phylogeny-guided (PG).
...
(a\) A VCF file can directly specify mutations for each variant.
