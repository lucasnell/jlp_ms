...
`zlibbioc` [@Morgan_2019] and
`Rhtslib` [@Hayden_2019]
to improve portability.
An overview of the methods is shown in Figure \@ref(fig:jackalope-overview-figure).
...
all nucleotides in the sequence [@Yang_2006].
...
[@Huang_2011], and
PacBio read simulation is based on `SimLoRD` 
[@St_cker_2016].
