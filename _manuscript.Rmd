...
generating a reference genome, simulating haplotypes from gene trees, and
...
`INDELible`.
I also used the same parameters for the last step, except that the variant haplotypes
were used for sequencing reads instead of a reference genome.
I generated 8 haplotypes with 20 chromosomes by creating a phylogenetic tree with
...
`jackalope` by writing them to an `ms`-style output file.
