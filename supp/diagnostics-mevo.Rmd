...
Gamma-distribution category (1 to 5 in this case), the original nucleotide, 
and the new nucleotide.
It also output when switching chromosomes, so I could match substitutions with
chromosomes.
I counted the number of mutations per chromosome, rate category, type of substitution.
...
# saveRDS(svar_output, "svar_output.rds")
svar_output <- readRDS("svar_output.rds")
...
I counted the number of mutations tree edge and 
...
# saveRDS(phy_output, "phy_output.rds")
phy_output <- readRDS("phy_output.rds")
