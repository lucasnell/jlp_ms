...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ref <-}\StringTok{ }\KeywordTok{read_fasta}\NormalTok{(}\StringTok{"dmel-6.27.fasta.gz"}\NormalTok{,}
                  \DataTypeTok{cut_names =} \OtherTok{TRUE}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sims <-}\StringTok{ }\KeywordTok{scrm}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"40"}\NormalTok{, ref}\OperatorTok{$}\KeywordTok{n_seqs}\NormalTok{(),}
                   \StringTok{"-t 1000 -I 2 20 20 100"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    sims <-}\StringTok{ }\KeywordTok{scrm}\NormalTok{(}
        \KeywordTok{paste}\NormalTok{(}\StringTok{"24 1"}\NormalTok{,}
              ...
              \CommentTok{# Species 2 derived from 1 at time 2.0:}
              \StringTok{"-ej 2.0 2 1"}\NormalTok{,  }
              \CommentTok{# Species 3 derived from 2 at time 1.0:}
              \StringTok{"-ej 1.0 3 2"}
\NormalTok{        ))}
